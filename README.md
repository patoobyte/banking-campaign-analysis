...
This project is part of an ING challenge at Becode-data science and AI bootcamp. Our mission is to develop an automated tool to compare campaigns from competitor banks and ING. Both traditional and challenger banks are included. Only campaigns on their website are investigated. 
