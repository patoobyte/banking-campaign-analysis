...
3. **DEMO - Overview** compares Left and Right campaigns or banks using compact, bounded-width radar and categorical charts. Numerical metrics each have an independent scale: bars show individual values or whole-bank means; box plots show bank distributions and coloured value markers for single campaigns. Up to three metrics can be charted at once. Missing metrics are not interpreted as zeros.
